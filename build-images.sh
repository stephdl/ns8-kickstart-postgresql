...
# --label="org.nethserver.images=docker.io/mariadb:10.11.17 docker.io/roundcube/roundcubemail:1.6.12-apache"
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.11-alpine docker.io/nginx:1.30.0-alpine" \
    "${container}"
# Commit the image
