...
# --label="org.nethserver.images=docker.io/mariadb:10.11.5 docker.io/roundcube/roundcubemail:1.6.15-apache"
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.9-alpine docker.io/nginx:1.28.0-alpine" \
    "${container}"
# Commit the image
